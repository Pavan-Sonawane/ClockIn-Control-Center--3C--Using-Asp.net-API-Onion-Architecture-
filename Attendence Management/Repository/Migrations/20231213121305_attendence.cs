        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AttendanceID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserID = table.Column<int>(type: "int", nullable: false),
                    ClockInDateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ClockOutDateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    ProductiveHours = table.Column<TimeSpan>(type: "time", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventDatTime = table.Column<DateTime>(type: "datetime2", nullable: false),
